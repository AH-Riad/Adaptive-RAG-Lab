...
def main():
    ...
    print("D²RAG FIQA DEV SMOKE TEST V7")
    ...
    for number, (
        ...
        if query_strategy_changed or query_top_k_changed:
            adaptation_delta = ndcg_at_5 - initial_ndcg_at_5
            adaptation_quality_deltas.append(adaptation_delta)
    ...
    print(
        "Average Adaptation nDCG@5 Delta:",
        round(
            average_adaptation_delta,
            4
        )
    ...
    print()
    print("D²RAG FIQA DEV SMOKE TEST V7 PASSED")
